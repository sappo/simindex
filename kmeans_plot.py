...
dataset1 = read_csv("plot-len550-min2-max385-step1.txt")
...
restaurant = read_csv("plot-len864-min2-max604-step1.txt")
...
febrl_4k = read_csv("plot-len5001-min2-max3500-step8.txt")
