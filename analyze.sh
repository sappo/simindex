    ...
    do
        if [ "$2" == '-b' ]; then
            ...
            mprof run analyzer.py \
                ...
                -s ${datasetprefix}${dataset}_${fit}_gold.csv -g id_1 -g id_2 \
                ...
                ${datasetprefix}${dataset}_${query}_query.csv \
                ${datasetprefix}${dataset}_${fit}.csv
            ) || exit 1
        else
            # Fit model once!
            (
        ...
        mprof run analyzer.py \
            ...
            -s ${datasetprefix}${dataset}_${query}_gold.csv -g id_1 -g id_2 \
